      ...
      <div className="space-y-8 text-muted-foreground">
        <section className="space-y-4">
          ...
          <div>
            ...
            <p dangerouslySetInnerHTML={{ __html: sanitizeHtml(legalDict.betreiber) }} />
          </div>
          <div>
            <h3 className="text-2xl font-bold font-headline mb-2 text-foreground">{legalDict.kontaktTitle}</h3>
            <p dangerouslySetInnerHTML={{ __html: sanitizeHtml(legalDict.kontaktContent) }} />
          </div>
          <div>
            <h3 className="text-2xl font-bold font-headline mb-2 text-foreground">{legalDict.verantwortlichTitle}</h3>
            <p dangerouslySetInnerHTML={{ __html: sanitizeHtml(legalDict.verantwortlichContent) }} />
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div>
            ...
            <p dangerouslySetInnerHTML={{ __html: sanitizeHtml(legalDict.unabhaengigkeitContent) }} />
          </div>
          <div>
            <h3 className="text-2xl font-bold font-headline mb-2 text-foreground">{legalDict.tarifrechnerTitle}</h3>
            <p dangerouslySetInnerHTML={{ __html: sanitizeHtml(legalDict.tarifrechnerContent) }} />
          </div>
          <div>
            <h3 className="text-2xl font-bold font-headline mb-2 text-foreground">{legalDict.inhalteTitle}</h3>
            <p dangerouslySetInnerHTML={{ __html: sanitizeHtml(legalDict.inhalteContent) }} />
          </div>
          <div>
